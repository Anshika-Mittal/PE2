...
import { Stethoscope, Accessibility, HeartPulse,Activity,Monitor,Microscope, ShieldCheck, Thermometer, Bed } from "lucide-react";
...
const brandsWithIcon = [
  { id: "philips", label: "Philips Healthcare", icon: Stethoscope },
  { id: "omron", label: "Omron", icon: HeartPulse },
  { id: "medtronic", label: "Medtronic", icon: Activity },
  { id: "gehealthcare", label: "GE Healthcare", icon: Monitor },
  { id: "siemens", label: "Siemens Healthineers", icon: Microscope },
  { id: "bplmedical", label: "BPL Medical", icon: Thermometer },
];
